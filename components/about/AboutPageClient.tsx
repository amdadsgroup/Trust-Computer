    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl space-y-12">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-sm space-y-8">
        ...
        <div className="bg-slate-900 text-slate-200 p-6 rounded-2xl space-y-3 text-xs">
          ...
          <p><strong className="text-white">{t('about.cred_owner', 'Proprietor / Owner:')}</strong> Shiblu Ahmed</p>
          ...
          <p><strong className="text-white">{t('about.cred_developer', 'Software Developed BY:')}</strong> Amdads Group</p>
        </div>
