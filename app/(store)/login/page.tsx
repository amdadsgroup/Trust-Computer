    ...
    <div className="max-w-md w-full space-y-6">
      <div className="text-center space-y-3">
        ...
        <p className="text-xs sm:text-sm text-slate-500">
          Sign in to access your order history, saved addresses, and profile.
        </p>
      </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link
              ...
              className="text-[11px] font-semibold text-[#0084d6] hover:underline"
            >
              Forgot Password?
            </Link>
          </div>
        ...
        <div className="flex items-center justify-between text-xs pt-1">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded text-[#2A3B97] focus:ring-[#2A3B97]"
            />
      ...
      <div className="text-center text-[11px] text-slate-400 flex items-center justify-center gap-2">
        ...
        <span>Protected with secure authentication & encryption</span>
      </div>
    </div>
  );
}
